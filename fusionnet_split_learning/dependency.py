# image root
test_index_path = '../data/release_v0/meta/test_indexes.csv'
train_index_path = '../data/release_v0/meta/train_indexes.csv'
val_index_path = '../data/release_v0/meta/valid_indexes.csv'
img_info_path = '../data/release_v0/meta/meta.csv'
source_dir = '../data/release_v0/images/'

# label_list
nevus_list = ['blue nevus', 'clark nevus', 'combined nevus',
              'congenital nevus', 'dermal nevus', 'recurrent nevus', 'reed or spitz nevus']
basal_cell_carcinoma_list = ['basal cell carcinoma']
melanoma_list = ['melanoma', 'melanoma (in situ)', 'melanoma (less than 0.76 mm)',
                 'melanoma (0.76 to 1.5 mm)', 'melanoma (more than 1.5 mm)', 'melanoma metastasis']
miscellaneous_list = ['dermatofibroma', 'lentigo',
                      'melanosis', 'miscellaneous', 'vascular lesion']
SK_list = ['seborrheic keratosis']
label_list = [nevus_list, basal_cell_carcinoma_list,
              melanoma_list, miscellaneous_list, SK_list]

# seven-point
pigment_network_label_list = [['absent'], [
    'typical'], ['atypical']]  # 'typical:1,atypical:2
streaks_label_list = [['absent'], ['regular'],
                      ['irregular']]  # regular:1, irregular:2
...
dots_and_globules_label_list = [['absent'], [
    'regular'], ['irregular']]  # regular:1, irregular:2
blue_whitish_veil_label_list = [['absent'], ['present']]  # present:1
vascular_structures_label_list = [['absent'],
                                  ['within regression', 'arborizing',
                                      'comma', 'hairpin', 'wreath'],
...
num_level_of_diagnostic_difficulty_label_list = len(
    level_of_diagnostic_difficulty_label_list)
