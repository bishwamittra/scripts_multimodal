...
class ResNet_Tail(nn.Module):
    # def __init__(self, block, num_blocks, channel=3, num_classes=10, norm='instancenorm'):
    def __init__(self, block, num_classes, norm='instancenorm'):
...
def ResNet50_Head(channel):
    return ResNet_Head(channel=channel)

def ResNet50_Tail(num_classes):
    return ResNet_Tail(Bottleneck, num_classes)