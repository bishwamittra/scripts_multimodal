...
for j in range(round_):
    ...
    weight_file_evaluated = './{}_{}_{}_weight_file/{}/checkpoint/best_mean_acc_model.pth'.format(mode,model_name,'self_evaluated', i)
...
averaged_avg_acc = np.mean([mean_avg_acc_list[0]])
searched_avg_acc = np.mean([mean_avg_acc_list[1]])
