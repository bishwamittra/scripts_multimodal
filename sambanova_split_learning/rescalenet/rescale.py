...
from .layers import AvgPool2d, Bias2DMean
...
class ReScale_front(nn.Module):
    def __init__(self,
                 ...
                 input_shapes=(None, None),
                 num_flexible_classes=-1):
        super(ReScale_front, self).__init__()
...
def rescale18_back(num_classes=1000, drop_conv=0.0, drop_fc=0.0, **kwargs):
    return ReScale_back([2, 2, 2, 2],
...
def rescale18_front(num_classes=1000, drop_conv=0.0, drop_fc=0.0, **kwargs):
    return ReScale_front([2, 2, 2, 2],
                   num_classes=num_classes,
                   drop_conv=drop_conv,
                   drop_fc=drop_fc,
                   groups=1,
