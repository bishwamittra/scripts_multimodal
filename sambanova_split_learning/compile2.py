...
# sys.path.append("/nvmedata/scratch/shrirajp/Astar_updated_code/classification_1.16.5-38")
...
def main(args):
	...
	if args.command == "test":
		...
		host = '10.9.240.14'  # SN30_Node1 - 10.19.64.32, A*Star using IP - 10.9.240.14
		# host = '10.2.16.246'
		port = 8890
		seed = 777
		...
		print("\n\nComment out the sys.exit() (line 441) to run the go to the for loop\n\n")
		# sys.exit()
...
-b 256 \
-p /nvmedata/scratch/shrirajp/Astar_updated_code/rescale18_split/rescale18_split.pef \
-v \
--in-height 8 \
--model rescale18 \
--drop-conv 0.0 \
